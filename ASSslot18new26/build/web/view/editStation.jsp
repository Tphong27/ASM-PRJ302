            ...
            <form action="${pageContext.request.contextPath}/inspectionStation" method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="stationName" class="form-control" value="${station.name}" required="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="form-group col-md-6">
                        <label>Email</label>
                        <input type="text" name="Email" class="form-control" value="${station.email}" required="">
                    </div>
                </div>
