                    ...
                    <div class="form-container">
                        ...
                        <form action="vehicles" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="PlateNumber" id="plateNumber" class="form-control" value="${vehicle.plateNumber}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="Modelid" id="modelId" class="form-select">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="ManufactureYear" id="manufactureYear" class="form-control" value="${vehicle.manufactureYear}" required>
                            </div>

                            <div class="form-group">
                                <label for="engineNumber">Engine Number</label>
                                <input type="text" name="EngineNumber" id="engineNumber" class="form-control" value="${vehicle.engineNumber}" required>
                            </div>
