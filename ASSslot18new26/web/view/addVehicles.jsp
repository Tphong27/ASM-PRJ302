                    ...
                    <div class="form-container">
                        ...
                        <form action="vehicles" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="PlateNumber" id="plateNumber" class="form-control" value="${PlateNumber}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="ManufactureYear" id="manufactureYear" class="form-control" value="${year}" required>
                            </div>

                            <div class="form-group">
                                <label for="engineNumber">Engine Number</label>
                                <input type="text" name="EngineNumber" id="engineNumber" class="form-control" value="${EngineNumber}" required>
                            </div>
