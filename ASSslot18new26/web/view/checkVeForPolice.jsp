...
<html lang="en">
    <head>
        ...
        <title>Check Vehicle for Police</title>
    ...
    <body>
        ...
        <div class="main-content">
            <!-- Check Vehicle Hero Section -->
            <div class="checkve-hero">
                <div class="hero-content">
                    <div class="hero-text">
                        <h1>Welcome Officer ${userAccount.fullname}</h1>
                        <p>Check vehicle details or inspection records from the menu above.</p>
                    </div>
                    <a href="#vehicle-list" class="btn-custom">View Vehicle List</a>
                </div>
            </div>
            ...
            <div class="container mt-5" id="vehicle-list">
                ...
                <!-- Search Form -->
                <form action="${pageContext.request.contextPath}/vehicles" method="get" class="mb-4" >
