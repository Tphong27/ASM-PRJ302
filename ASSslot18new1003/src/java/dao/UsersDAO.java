...
<<<<<<< HEAD
        boolean hasUpper = false; //kiểm tra chữ cái viết hoa
        boolean hasLower = false; //kiểm tra chữ cái thường
        boolean hasDigit = false; //kiểm tra số
        boolean hasSpecial = false; //kiểm tra kí tự đặc biệt
=======
...
<<<<<<< HEAD
        // Kiểm tra độ dài phải là 10 chữ số và chỉ chứa số
=======
>>>>>>> 9b0e173 (Cập nhật code)
