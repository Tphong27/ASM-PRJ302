...
<html lang="en">
    <head>
        ...
        <title>Check Vehicles By Admin</title>
    ...
    <body>
        ...
        <div class="container mt-3">
            <h1 class="text-center">Vehicles List</h1>

            <form action="${pageContext.request.contextPath}/vehicles">
                <input type="hidden" name="action" value="searchVehicleForAdmin">
                <div class="input-group w-60">
                    <input type="text" name="partOfPlate" class="form-control" placeholder="Enter license plate...">
