    ...
    <body>
        ...
        <div class="main-content">
            ...
            <div class="profile-container">
                <h2 class="profile-header"><i class="bi bi-person-circle me-2"></i>Your Information</h2>
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">${userAccount.fullname}</span>
                </div>

                <div class="info-item">
                    <i class="bi bi-lock"></i>
                    <span class="info-label">Password:</span>
                    <span class="info-value">${userAccount.password}</span>
                </div>

                <div class="info-item">
                    <i class="bi bi-telephone"></i>
                    <span class="info-label">Phone:</span>
                    <span class="info-value">${userAccount.phone}</span>
                </div>

                <div class="info-item">
                    <i class="bi bi-geo-alt"></i>
                    <span class="info-label">Address:</span>
                    <span class="info-value">${userAccount.address}</span>
                </div>
            </div>
            ...
            <div class="btn-edit-container">
                <form action="${pageContext.request.contextPath}/user" method="get">
                    ...
                    <button type="submit" class="btn btn-edit text-white"><i class="bi bi-pencil-square me-2"></i>Edit Profile</button>
                </form>
            </div>
        </div>
        <!-- Footer -->
